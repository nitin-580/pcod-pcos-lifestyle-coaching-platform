...
import { Mail, User, Phone, Calendar, Scale, ArrowRight, CheckCircle2, X } from 'lucide-react';
          ...
          >
            ...
            >
              ...
              {isSuccess ? (
                ...
                <>
                  {/* LEFT PANEL */}
                  <div className="w-full md:w-5/12 bg-gradient-to-br from-purple-600 to-pink-500 text-white p-10 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10 w-full aspect-[4/3] rounded-2xl overflow-hidden mt-4 shadow-xl border border-white/20 hidden md:block">
                      <img
